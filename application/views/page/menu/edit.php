                ...
                <div class="d-flex justify-content-center">
                    <div class="card col-6 ">
                        <div class="card-body">
                            ...
                            <form action="<?= base_url('menu/update/' . $input->ID_MENU) ?>" method="post">
                                <div class="form-group">
                                    ...
                                    <div class="from-group">
                                        ...
                                        <input type="text" value="<?= $input->NAMA_MENU ?>" class="form-control col-md-9 float-right" onkeyup="showMenu()" name=menu id="menu">
                                    </div>
                                    <br>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="<?= $input->LINK ?>" class="form-control" id="link" name="link" onkeyup="showLink()">
                                    <br>
                                    <br>
                                    <div class="row form-group justify-content-center">
                                    ...
                                    <?php if ($input->MEN_ID_MENU == null) : ?>
                                        ...
                                        <?php else : ?>
                                            ...
                                            <?php foreach ($menu as $select) { ?>
                                                <?php if ($select->ID_MENU == $input->MEN_ID_MENU) : ?>
                                                    <option selected value="<?= $select->ID_MENU ?>"><?= $select->NAMA_MENU ?></option>
                                                <?php else : ?>
                                                    <?php if ($input->ID_MENU != $select->ID_MENU) : ?>
