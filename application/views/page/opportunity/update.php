                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex no-block align-items-center">
                                    ...
                                    <div class="form-group m-t-40 row">
                                        ...
                                        <div class="col-10">
                                            <input readonly type="text" name="no_opportunity" class="form-control">
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-3">
                            <div class="card"> 
                                <div class="card-body">
                                    <h4>Aktivitas</h4>
                                    <span>
                                        <a href="#" id="daftar-aktivitas-opportunity">Daftar</a>
                                    </span> |
                                    <span>
                                        <a href="#" id="tambah-panggilan-telepon">Tambah Panggilan Telepon</a>
                                    </span> |
                                    <span>
                                        <a href="#" id="tambah-tugas">Tambah Tugas</a>
                                    </span>
                                    <hr>
                                    <div id='tableActivityOpportunity'>
                                        <table id='tampil-daftar-opportunity' class='table'>
                                            <thead>
                                                <tr>
                                                    <th>#</th>
                                                    <th>Informasi</th>
                                    ...
                                    <div id="form-tambah-panggilan-telepon">
                                        <form action="" class="form-material">
                                            <textarea class="form-control" id="deskripsi" placeholder="Kamu Harus Memasukkan Deskripsi"></textarea>
                                            <label for="jatuh-tempo">Jatuh Tempo</label>
                                            <input type="text" class="form-control" id="jatuh-tempo">
                                            <label for="telepon-dengan">Telepon Dengan <span style="color: red">*</span></label>
                                            <input type="text" id="telepon-dengan" class="form-control">
                                        </form>
                                    </div>      
                                </div>
                            </div>
